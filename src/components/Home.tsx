...
export default function Home() {
  return (
    <main className="flex flex-col w-full min-h-screen">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative w-full min-h-[90vh] flex items-center justify-center bg-primary-container text-on-primary py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <motion.div 
          className="relative z-10 max-w-[1280px] mx-auto flex flex-col items-center text-center gap-8 mt-12"
          initial="hidden"
          animate="visible"
          variants={staggerContainer}
        >
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/20 border border-secondary/40 text-secondary-container text-xs font-semibold tracking-widest uppercase mb-4 backdrop-blur-sm">
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-2 text-on-primary-container font-inter mt-2">
      ...
      <section className="w-full py-24 px-6 md:px-12 lg:px-24 bg-surface">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="bg-primary-container rounded-3xl p-10 aspect-square md:aspect-video lg:aspect-square flex flex-col justify-end relative overflow-hidden shadow-2xl group">
             {/* Animated Abstract Biological Nodes */}
             <div className="absolute inset-0 opacity-20 flex items-center justify-center transition-transform duration-1000 group-hover:scale-110">
