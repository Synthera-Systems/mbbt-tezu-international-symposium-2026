...
export default function AdminSidebar({ activeTab, setActiveTab, handleLogout }: SidebarProps) {
  ...
  return (
    ...
    <aside className="fixed max-h-screen inset-y-0 left-0 w-200 px-3 bg-white border-r border-surface-dim/30 z-30 hidden md:flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      <div className="p-8 pb-6">
        <h1 className="font-playfair text-xl font-bold text-center text-primary tracking-tight whitespace-nowrap">Admin Panel</h1>
